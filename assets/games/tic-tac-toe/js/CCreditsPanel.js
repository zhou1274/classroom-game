function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED,"50px Arial", "#ffffff");
        ...
        _oLink = new createjs.Text(TEXT_LINK,"50px Arial", "#ffffff");
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 +380, y: 754};
